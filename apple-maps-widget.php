	...
	protected function render() {
		...
		foreach ( $locations as &$location ) {
			...
			if ( $location_type === 'place_id' ) {
				...
				$location['place_name_override'] = ! empty( $location['place_name_override'] ) ? sanitize_text_field( $location['place_name_override'] ) : '';
			}
...
echo 'const defaultPinIconUrl = "' . esc_js( $default_pin_icon_url ) . '";';
		...
		echo '};';
		echo 'initializeAppleMaps(mapContainerId, mapLocations, mapKitToken, cameraDistance, colorScheme, mapSettings, cameraZoomRange, cameraBoundary, mapCenter, defaultPinColor, defaultPinIconUrl);';
		echo '})(0);';
		echo '</script>';
	}
}
